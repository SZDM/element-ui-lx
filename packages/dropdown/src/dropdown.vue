<script>
  ...
  import ElButton from 'element-ui-lx/packages/button';
  import ElButtonGroup from 'element-ui-lx/packages/button-group';
  import { generateId } from 'element-ui-lx/src/utils/util';
