...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'element-ui-lx/src/utils/date-util';
  import { hasClass } from 'element-ui-lx/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'element-ui-lx/src/utils/util';
