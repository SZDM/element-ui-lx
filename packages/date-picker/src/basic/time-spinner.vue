...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'element-ui-lx/src/utils/date-util';
  import ElScrollbar from 'element-ui-lx/packages/scrollbar';
  import RepeatClick from 'element-ui-lx/src/directives/repeat-click';
  ...
  export default {
    ...
    methods: {
      ...
      adjustSpinners() {
        ...
        this.adjustSpinner('seconds', this.secosnds);
      },
