...
<script>
import Popper from 'element-ui-lx/src/utils/vue-popper';
import Clickoutside from 'element-ui-lx/src/utils/clickoutside';
import Emitter from 'element-ui-lx/src/mixins/emitter';
import Locale from 'element-ui-lx/src/mixins/locale';
import Migrating from 'element-ui-lx/src/mixins/migrating';
import ElInput from 'element-ui-lx/packages/input';
import ElTag from 'element-ui-lx/packages/tag';
import ElScrollbar from 'element-ui-lx/packages/scrollbar';
import ElCascaderPanel from 'element-ui-lx/packages/cascader-panel';
import AriaUtils from 'element-ui-lx/src/utils/aria-utils';
import { t } from 'element-ui-lx/src/locale';
import { isEqual, isEmpty, kebabCase } from 'element-ui-lx/src/utils/util';
import { isUndefined, isFunction } from 'element-ui-lx/src/utils/types';
import { isDef } from 'element-ui-lx/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'element-ui-lx/src/utils/resize-event';
